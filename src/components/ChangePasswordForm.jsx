...
    const inputStyle = "bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-md focus:ring-rose-500 focus:border-rose-500 block p-2.5 transition-colors shadow-sm";
...
                        type="submit" 
                        disabled={isLoading}
                        className="px-6 py-2.5 bg-rose-600 hover:bg-rose-700 dark:bg-rose-500 dark:hover:bg-rose-600 text-white rounded-md font-bold transition-all shadow-md active:scale-95 disabled:bg-gray-300 dark:disabled:bg-gray-700 dark:disabled:text-gray-500"
                    >
