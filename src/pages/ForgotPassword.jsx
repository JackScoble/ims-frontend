    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 transition-colors">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight">Reset Password</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Enter your email and we'll send you a link to get back into your account.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm">
          <Link to="/login" className="font-bold text-[#8884d8] dark:text-[#a5a1ff] hover:text-[#706ac9] hover:underline transition-colors flex items-center justify-center gap-1">
